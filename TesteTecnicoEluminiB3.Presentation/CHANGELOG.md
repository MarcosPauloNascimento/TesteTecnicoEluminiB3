...
- Crie um projeto angular com ng: `ng new TesteTecnicoEluminiB3.Presentation --defaults --skip-install --skip-git --no-standalone `.
- Atualize angular.json com a porta.
- Criar o arquivo de projeto (`TesteTecnicoEluminiB3.Presentation.esproj`).
